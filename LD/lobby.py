...
class Lobby:
    ...
    def __init__(self, num_users, latitude=40.712776,
                 longitude=-74.005974, generate_suggestions=False,
                 num_suggestions=1):
        self.lat = latitude
        self.lon = longitude
    ...
    def to_json(self):
        return {'lat': self.lat, 'lon': self.lon,
                'num_users': self.num_users, 'game_id': self.game_id,
                'suggestions': self.suggestions, 'users': list(self.users)}
